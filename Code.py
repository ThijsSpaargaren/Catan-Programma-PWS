...
def main():
    ...
    try:
        if turn == "1":
            ...
            Player_Number = input("What player number are you?")
            ...
            if Player_Number == "1":
                ...
                while True:
                    ...
                    Placement_1 = input("What coordinates was the first")
                ...
                while True:
                    ...
                    Placement_2 = input("What coordinates was the second")
                ...
                while True:
                    ...
                    Placement_3 = input("What coordinates was the third")
            ...
            while True:
                Build_1 = input("What coordinates was your first build at? ")
                if Build_1 in Spot_Values_Dict.keys() and Spot_Values_Dict.get(Build_1) > 0 :
        
                        

                    Lumber_Production = input("What number(s) do you have for Lumber production? ")
                    Clay_Production = input("What number(s) do you have for Clay production? ")
                    Sheep_Production = input("What number(s) do you have for Sheep production? ")
                    Wheat_Production = input("What number(s) do you have for Wheat production? ")
                    Ore_Production = input("What number(s) do you have for Ore production? ")
                    ...
                    #Check if any adjacent tiles are bordering
            ...
            if Player_Number == "4":
                ...
                while True:
                    ...
                    Placement_4 = input("What coordinates was the fourth? ")
                ...
                while True:
                    ...
                    Placement_5 = input("What coordinates was the fifth? ")
                ...
                while True:
                    ...
                    Placement_6 = input("What coordinates was the sixth? ")
                ...
                while True:
                    ...
                    Placement_7 = input("What coordinates was the seventh? ")
            ...
            while True:
                Build_1 = input("What coordinates was your second build at? ")
                if Build_1 in Spot_Values_Dict.keys() and Spot_Values_Dict.get(Build_1) > 0 :
